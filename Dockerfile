...
RUN apt-get install -y --no-install-recommends php php-fpm php-intl php-curl php-gd php-mcrypt php5-json php7.0-mbstring php7.0-zip php7.0-dom php-mysql php5-readline
